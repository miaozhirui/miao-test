...
<head>
    ...
    <style type="text/css">
      ...
      .tab a{display: block; width:50px; height:50px; margin-top: 10px; line-height: 50px; text-align: center; color:white; font-size: 18px; text-decoration: none; transition:transform 0.5s;}
      .tab a.second{color:red; font-weight: 700}
      ...
      img{width:300px; height:300px;display:block; -webkit-animation: myfirst 2s }
      /*.tab a.*/
    </style>
</head>
<body>
    <div id="echart" >
      ...
      <div class="tab">
      <a href="http://m.local-test.com/heikes/view/" class="first" style="margin-top:250px;">A</a>
      <a href="javascript:;" class="second">B</a>      
    </div>
</body>
</html>