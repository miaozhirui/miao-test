...
* @Last Modified time: 2014-04-27 21:42:29
*/
/**
 * 将视图模型实例化成一个具体的函数通过这个函数来访问里面的数据
...
function success($msg,$url=''){
    ...
    echo  "<span id='one' style='color:red'>2</span>";
     echo "<script>
          a=2;
...
function error($msg,$url=''){
    ...
    echo  "<span id='one' style='color:red;font-size:70px;'>2</span>";
     echo "<script>
          a=2;
        var obj=document.getElementById('one')
        setInterval(function(){ 
...
function halt($data){
  echo "<div style='width:100%;height:100px;border:1px solid red;font-size:30px;line-height:100px;text-align:center;color:blue'>".$data."</div>";
}
