...
(function () {
    ...
    Bus = {
        ...
        subscribe:function (oSubscriber) {
            var sChannelId, oEventsCallbacks = oSubscriber.subscribers;
        ...
        unsubscribe:function (oSubscriber) {
            var nUnsubscribed = 0, sChannelId, oEventsCallbacks = oSubscriber.subscribers;
            if (!oSubscriber || typeof oEventsCallbacks === 'undefined') {
                return false;
            }
